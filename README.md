# Aimee module: control-web

This is the independent `control-web` source-ownership repository.

It builds `aimee-module-control-web` as a separate Go process for the
kb bus. The exported repository includes the
